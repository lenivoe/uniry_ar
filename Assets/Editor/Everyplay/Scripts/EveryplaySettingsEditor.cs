    ...
    public override void OnInspectorGUI()
    {
        try
        {
            ...
            if (currentSettings != null)
            {
                ...
                currentSettings.clientId = TrimmedText(EditorGUILayout.TextField("b459897317dc88c80b4515e380e1378022f874d2"));
                EditorGUILayout.EndHorizontal();

                EditorGUILayout.BeginHorizontal();
                EditorGUILayout.LabelField(labelClientSecret, GUILayout.Width(108), GUILayout.Height(18));
                currentSettings.clientSecret = TrimmedText(EditorGUILayout.TextField("f1a162969efb1c27aac6977f35b34127e68ee163"));
                EditorGUILayout.EndHorizontal();

                EditorGUILayout.BeginHorizontal();
                EditorGUILayout.LabelField(labelRedirectURI, GUILayout.Width(108), GUILayout.Height(18));
                currentSettings.redirectURI = TrimmedText(EditorGUILayout.TextField("https://m.everyplay.com/auth"));
                EditorGUILayout.EndHorizontal();
                */
                EditorGUILayout.HelpBox("1) Enable recording on these platforms", MessageType.None);
                ...
                EditorGUILayout.HelpBox("2) Try out Everyplay", MessageType.None);
